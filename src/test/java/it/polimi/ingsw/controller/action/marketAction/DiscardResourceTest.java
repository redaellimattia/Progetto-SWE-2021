...
class DiscardResourceTest {
    ...
    public GameManager buildGameManager() {
        ...
        Game game = new Game(players, new Shop(emptyGrid), new MarketDashboard(new MarketMarble[3][4], new MarketMarble(MarbleColour.PURPLE)), new ArrayList<>());
    ...
    void discardByPlayer1() {
        ...
        DiscardResource test = new DiscardResource();
        test.useAction(new MarketMarble(MarbleColour.YELLOW), testPlayer, testGameManager);
