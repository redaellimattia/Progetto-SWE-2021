...
class ShopTest {
    ...
    void buy() { //CHECK BUY METHODS AND ALL CORNER CASES (DECK EMPTY)
        ...
        assertTrue(shop.getGrid()[2][2].getDeck().size() == 4); //same problem with removeFirst()
        bought = shop.buy(1,2);
        bought = shop.buy(1,2);
        bought = shop.buy(1,2);
    ...
    void discardFromToken() {
        ...
        assertTrue(shop.getGrid()[0][3].getDeck().size() == 4);
        assertTrue(shop.getGrid()[1][3].getDeck().size() == 4);
        assertTrue(shop.getGrid()[2][3].getDeck().size() == 4);
        shop.discardFromToken(purple);
        assertTrue(shop.getGrid()[0][3].getDeck().size() == 2);
        assertTrue(shop.getGrid()[1][3].getDeck().size() == 2);
